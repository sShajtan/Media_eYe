                ...
                <div className="creator_account_main">
                    ...
                    <div className="creator_account_main_header">
                        ...
                        <div className="creator_account_info">
                            ...
                            <div className="account_info">
                                I don’t accept bids unless on auction 
                                Everything not sold from first collection will be burned by September 10th,
                                Second collection coming soon 
                            </div>
                            <div className="account_links">
                                <div>
                                    <span><i>555</i>followers</span>
                                    <button className="account_follow"><span>Follow</span></button>
                                </div>
                                <div>
                                    <span><i>55</i>following</span>
                                    <button className="account_share"><span>Share</span></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="creator_account_menu_wrapper">
                        <div className="creator_account_menu">
                            <button>
                                <span>On sale <i>40</i></span>
                            </button>
                            <button>
                                <span>Owned <i>43</i></span>
                            </button>
                            <button>
                                <span>Created <i>72</i></span>
                            </button>
                            <button>
                                <span>Liked <i>39</i></span>
                            </button>
                            <button>
                                <span>Activity</span>
                            </button>
