    ...
    <div className="collection_product">
      <div className="container">
        ...
        <div className="collection_product_main">
          ...
          <div className="collection_block collection_block_url">
            <label onClick={() => setShowAddContent(!showAddContent)}>
              Add content (Optional) &nbsp;&nbsp; &nbsp;
              <span
                className={
                  showAddContent ? 'content_arrow active' : 'content_arrow'
                }
              >
                &#10094;
              </span>
          ...
          <div className="collection_block collection_block_url">
            ...
            <div className="active_minters">{activeMintersList}</div>
          </div>
