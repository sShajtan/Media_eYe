            ...
            <a className="tutorial">Tutorial &#5125;</a>
                <div className="collection_product_main">
                    ...
                    <div className="collection_block collection_block_category">
                        <h5>Category</h5>
                        <span>Adding a catrgory will help make your item discoverable on Media eYe.</span>
                        <div>
                        <Select
                    ...
                    <div className="collection_block collection_block_links">
                        <span>Links</span>
                        <div><input placeholder="yoursite.io" /></div>
                        <div><input placeholder="https://discord.gg/abcde" /></div>
                        <div><input placeholder="https://twitter.com/YourTwitterHandle" /></div>
                        <div><input placeholder="https://www.instagram.com/YourInstagramHandle" /></div>
                        <div><input placeholder="https://www.medium.com/@YourMediumHandle" /></div>
                        <div><input placeholder="https://t.me/abcdef/" /></div>
                    </div>
                    ...
                    <div className="collection_block collection_block_buttons collection_block_blockchain">
                        ...
                        <div>
                            <button>
                                <img src={darkTheme ? "../img/eth_sm.png" : "../img/eth_sm_dark.png" } />
                                <div>
                                    <h6>ETH</h6>
                                    <span>Ethereum</span>
                                </div> 
