...
const ProfileSettings = (props) => {
  ...
  return (
    <div className="profile_settings_page">
        ...
        <div className="profile_settings_block">
            ...
            <div className="profile_settings_block_buttons">
              <button className="profile_settings_unset"><img src="../../img/profile_settings/unset.png" />Unset</button>
              <button className="profile_settings_button"><span>Enable</span></button>
            </div>
        </div>
        <div className="profile_settings_block">
            <div className="profile_settings_block_info">
    ...
    <button className="create_wallet"><span>Save Changes</span></button>
    </div>
  );
};
