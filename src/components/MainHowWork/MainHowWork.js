        ...
        return (
            <div className="main_howwork">
                <div className="container">
                    <img className="title animate__animated animate__zoomIn wow" data-wow-duration="1.5s" data-wow-delay="1s" src="img/howwork_title.svg" />
                    <div className="main_howwork_main">
                        <div className="main_howwork_main_block animate__animated animate__fadeInUp wow" data-wow-duration="1.5s" data-wow-delay="1s">
