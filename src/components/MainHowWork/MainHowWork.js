...
class MainHowWork extends React.Component {
    render() {
        return (
            <div className="main_howwork">
                <div className="container">
                    <img className="title animate__animated animate__zoomIn wow" data-wow-duration="1s" data-wow-delay="0.5s" src="img/howwork_title.svg" />
