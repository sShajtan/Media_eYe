    ...
    <div className="product">
        <div className="container">
          <div className="product_main">
            ...
            <svg width="100%" className="product_border"  viewBox="0 0 558 669" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M45.6569 10L12.5451 40.7271V268.107L19.3099 273.911V307.711L14.6813 312.15H6.13636V327.172H4.00011V658L521.684 657.659L549.455 630.004V574.695L543.402 568.55V452.811H558V668.242H0.439697V0.44046H558V418.67L548.387 410.818V310.443H539.13L535.214 307.37V231.918L549.099 218.603V108.327L538.062 96.7186H524.176L433.386 10H45.6569Z" fill="#141233"/>
            </svg>
            </div>
            <div className="product_right">
              <h2>Product ID</h2>
              <div className="product_header">
                <span><img src="img/star.png" />Proprietary</span>
              ...
              <div className="product_price">
                <div className="product_price_block">
                  <div><strong>Price</strong><span>0.053 ETH </span><i>($123)</i></div>
                  <div><strong>or</strong><span>12345 eYe </span><i>($120)</i></div>
                </div>
                <div className="product_price_buttons">
                  <button className="buy_now">Buy Now</button> <button className="add_to_basket">Add to basket</button>
                </div>
              </div> 
            </div>
          </div>
