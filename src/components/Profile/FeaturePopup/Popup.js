                  ...
                  <div className="feature_popup_main">
                      ...
                      <div>
                        <div className="marketplace_block_info">
                          ...
                          <div className="on_sale_in_checkbox">
                                <input id='30day' type="checkbox" checked={activeDay === '30' ? true : null } onClick={() => setActiveDay('30')} />
                                <label htmlFor='30day'>
                                  <span></span>
                                </label>
                              </div>
                        ...
                        <div className="marketplace_block_info">
                          90 days
                          <div className="on_sale_in_checkbox">
                                <input id='90day' type="checkbox" checked={activeDay === '90' ? true : null } onClick={() => setActiveDay('90')} />
                                <label htmlFor='90day'>
                                  <span></span>
                                </label>
                              </div>
                    ...
                    <div className="feature_payments_token">
                         ...
                         <div className="collection_block_buttons">
                          ...
                          <button className={activeToken == 'USDT' ? 'active' : null} onClick={() => {setActiveToken('USDT')}}>
                        ...
                        <div className="feature_popup_footer">
                          <p>Paying in eye, there is 15% discount, as well as a 10% discount for choosing 90 days, these discounts stack.</p>
                        </div>
                    </div>
