    ...
    <div className="profile_wallet_page">
      ...
      <div className="profile_wallet_page_main">
        <div className="profile_wallet_block">
          <span className="profile_wallet_block_title">
            Crypto eYe
          </span>
          <span className="profile_wallet_block_result">
            0,0000 Crypto eYe
          </span>
        </div>
        <div className="profile_wallet_block">
      ...
      <button className="create_wallet"><span>Create Account Wallet</span></button>
      <div className="profile_wallet_connect_wallet">
       <h6>Connect your Wallet</h6>
       <div>
          <button className="create_wallet_metamask wallet_btn">MetaMask</button>
          <button className="create_wallet_trust wallet_btn">Trust Wallet</button>
      </div>
        <h6>Fund your account wallet with Credit Card or Crypto</h6>
       <div>
          <button className="create_wallet_onramper wallet_btn">OnRamper</button>
          ...
          <button className="create_wallet_crypto  wallet_btn">Crypto.com</button>
      </div>
      </div>
