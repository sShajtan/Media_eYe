          ...
          <div className="faq_main">
            ...
            >
              ...
              <span className={question_6 ? 'active' : null}>
                To keep our platform safe, friendly and protect users, we
                moderate all content that is uploaded to the MeDIA eYe Platform.
                We ensure a great experience for all our users, while providing
                a safe environment to create, promote, collect, buy, sell, gift,
                entertain and earn.
              </span>
            </div>
            <div
            ...
            >
              ...
              <span className={question_9 ? 'active' : null}>
                ...
                distributed storage, which is always free, or to create storage
                of your NFT content and metadata on the blockchain. This ensures
                your content and data are immutable. Please refer to the rate
                sheet for charges associated with storage on the blockchain.
                These options are available to choose from in your user account.
              </span>
            </div>
            <div
              className={
            ...
            >
              ...
              <span className={question_10 ? 'active' : null}>
                ...
                our on-ramp service and then purchase the relevant crypto
                assets. Purchased assets will be transferred to your user
                account wallet. It is that simple and now you're ready to start
                using MeDIA eYe.
              </span>
            </div>
          </div>
