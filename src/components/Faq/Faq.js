          ...
          <div className="faq_main">
            ...
            >
              <div onClick={() => setQuestion_1(!question_1)}>
                ...
                <strong className={question_1 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
            ...
            >
              <div onClick={() => setQuestion_2(!question_2)}>
                ...
                <strong className={question_2 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
              <span className={question_2 ? 'active' : null}>
                Yes, you can and it is up to you if you decide to sell it later
                or not.
              </span>
            </div>
            <div
            ...
            >
              <div onClick={() => setQuestion_3(!question_3)}>
                ...
                <strong className={question_3 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
              <span className={question_3 ? 'active' : null}>
                Yes, you can and its up to you if you decide to sell it later or
                not, you can also send multiple NFTs or a series of NFTs using
                the campaign launcher as part of a unique subscription service
                we offer. You can send an NFT to as many people as you wish on
            ...
            >
              <div onClick={() => setQuestion_4(!question_4)}>
                ...
                <strong className={question_4 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
            ...
            >
              <div onClick={() => setQuestion_6(!question_6)}>
                ...
                <strong className={question_6 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
              <span className={question_6 ? 'active' : null}>
                You are able to upload your own digital content, to keep our
                platform safe, friendly and protect users from malicious
                content, we moderate all content that is uploaded to the MeDIA
                eYe Platform. We ensure a great experience for all our users,
                while providing a safe environment to create, promote, collect,
                buy, sell, gift, entertain and earn.
              </span>
            </div>
            <div
              className={
            ...
            >
              <div onClick={() => setQuestion_7(!question_7)}>
                ...
                <strong className={question_7 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
            ...
            >
              <div onClick={() => setQuestion_8(!question_8)}>
                ...
                <strong className={question_8 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
              <span className={question_8 ? 'active' : null}>
                ...
                unique wallet address and keys. You can also sign up using a
                DeFi wallet, which would then be registered as your unique
                address on the MeDIA eYe NFT Portal as part of your user account
                on the platform.
              </span>
            </div>
            <div
            ...
            >
              <div onClick={() => setQuestion_9(!question_9)}>
                ...
                <strong className={question_9 ? 'active' : null}>
                  &#10095;
                </strong>
              </div>
              <span className={question_9 ? 'active' : null}>
                Yes, you can choose either to store your data on IPFS
                distributed storage which is always free or to create storage of
                your NFT content and metadata on the blockchain, for example on
                Filecoin, in turn ensuring that your content and data are
                immutable, please refer to rate sheet for charges associated
                with storage on the blockchain. These options are available in
                your user account to choose from.
              </span>
            </div>
            <div
              className={
            ...
            >
              <div onClick={() => setQuestion_10(!question_10)}>
                <h5>
                  Can I onboard FIAT currency to the MeDIA eYe NFT Portal and
                  use it buy NFTs?
                </h5>
              ...
              <span className={question_10 ? 'active' : null}>
                You can onboard approved FIAT currencies to the platform using
                our on-ramp service and then purchase the relevant crypto assets
                which will be transferred to your user account wallet, its that
                simple and your are ready to start using MeDIA eYe..
              </span>
            </div>
          </div>
        </div>
