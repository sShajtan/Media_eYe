                ...
                <div className="creator_account_main">
                   ...
                   <div className="creator_account_filter">
                        ...
                        <div className="creator_account_filter_center">
                            <button className={activeTab === 'owner' ? "active" : null } onClick={() => dispatch(updateActiveTab('owner'))}>Owner</button>
                            <button className={activeTab === 'minter' ? "active" : null } onClick={() => dispatch(updateActiveTab('minter'))}>Minter</button>
                        </div>
                        <button className="create_collection" onClick={() => history.push("/create/collection", { fromPopup: true })}>Create Collection</button>
