            ...
            <div className="container">
                <div className="creator_account_main">
                   <div className="img_line">
                    ...
                    {activeTab === "minter" ? null : <button className="create_collection create_collection_mobile" onClick={() => history.push("/create/collection")}>Create Collection</button>}
                    {activeTab === "minter" ? <h3>You are Minter of the Collection 1 [Title]</h3> : null}
                    ...
                    <div className="active_minters">
                        {activeMinters.length > 0 ? <h4>{activeMinters.length} Minters</h4> : null }
                        {activeMintersList}
                    </div>
