  ...
  return (
    <React.Fragment>
      ...
      <div className={props.showPopup ? 'popup active' : 'popup'}>
        <div className="popup-wrapper mint_popup" onClick={props.togglePopup}>
          <div onClick={(event) => event.stopPropagation()}>
            <div className="container">
              <div className="main_mint_popup">
                ...
                <button className="mint_btn" onClick={() => sendForm()}>
                  Mint
                </button>
              </div>
            </div>
