...
<div className="filter_wrapper">
                            <button className={showFilter ? "filter_button open" : "filter_button" } onClick={toggleFilter}>
                            ...
                            <Collapse isOpened={showFilter} >
                                <div className="filter_block" onClick={(event) => event.stopPropagation()}>
                                    <ul>
                                        <li onClick={toggleStatus}>
                                            <div  className={status ? "filter_title status_title open" : "filter_title status_title"} >
                                                <span>Status</span>
                                                <span>&#10095;</span>
                                            </div>
                                            <Collapse isOpened={status} >
                                                <div className="filter_fields status_filter" onClick={(event) => event.stopPropagation()}>
                                        ...
                                        <li onClick={togglePrice}>
                                            <div className={price ? "filter_title price_title open" : "filter_title price_title"}>
                                                <span>Price</span>
                                                <span>&#10095;</span>
                                            </div>
                                            <Collapse isOpened={price} >
                                                <div className="filter_fields price_filter" onClick={(event) => event.stopPropagation()}>
                                                    <select>
                                        ...
                                        <li onClick={toggleCollections}>
                                            <div className={collections ? "filter_title collections_title open" : "filter_title collections_title"}>
                                                <span>Collections</span>
                                                <span>&#10095;</span>
                                            </div>
                                            <Collapse isOpened={collections} >
                                                <div className="filter_fields collections_filter" onClick={(event) => event.stopPropagation()}>
                                        ...
                                        <li onClick={toggleChains}>
                                            <div className={chains ? "filter_title chains_title open" : "filter_title chains_title" }>
                                                <span>Chains</span>
                                                <span>&#10095;</span>
                                            </div>
                                            <Collapse isOpened={chains} >
                                                <div className="filter_fields chains_filter" onClick={(event) => event.stopPropagation()}>
                                                    ?....
                                                </div>
                                            </Collapse>
                                        </li>
                                        <li onClick={toggleCategories}>
                                            <div className={categories ? "filter_title categories_title open" : "filter_title categories_title" }>
                                        ...
                                        <li onClick={toggleOnSaleIn}>
                                            <div className={onSaleIn ? "filter_title on_sale_in_title open": "filter_title on_sale_in_title" }>
                                                <span>On Sale In</span>
                                                <span>&#10095;</span>
                                            </div>
                                            <Collapse isOpened={onSaleIn} >
                                                <div className="filter_fields on_sale_in_filter" onClick={(event) => event.stopPropagation()}>
